...
%prep
%setup -q -n pycurl-7.43.0.6
cd %{_builddir}/pycurl-7.43.0.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615866867
...
cp %{_builddir}/pycurl-7.43.0.6/COPYING-LGPL %{buildroot}/usr/share/package-licenses/pycurl/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/pycurl-7.43.0.6/COPYING-MIT %{buildroot}/usr/share/package-licenses/pycurl/23874c749f03fc84ce09a6b4a6573919b0d02775
