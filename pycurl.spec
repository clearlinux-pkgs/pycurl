...
Source0  : https://files.pythonhosted.org/packages/0f/db/856a430445d6cd631a7c97f028e3a9d947f84a1a27c42b5d47245eae920e/pycurl-7.44.0.tar.gz
...
%prep
%setup -q -n pycurl-7.44.0
cd %{_builddir}/pycurl-7.44.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628538159
...
cp %{_builddir}/pycurl-7.44.0/COPYING-LGPL %{buildroot}/usr/share/package-licenses/pycurl/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/pycurl-7.44.0/COPYING-MIT %{buildroot}/usr/share/package-licenses/pycurl/d1ebf48633c3db6493f3bb20b4ba5d9323e28d2f
